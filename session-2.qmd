...
4. Join the household subset data. (Note: the household subset used in this and the previous lab does not contain records for 2021. So, you need to create a corresponding subset).
